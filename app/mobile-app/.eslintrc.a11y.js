 ...
 * every rule as a warning (has-accessibility-hint excepted, see below). docs/accessibility.md (repo root) holds the plan
...
module.exports = {
  ...
  rules: {
    ...
    // not obvious) — step 3 of "Plan: warnings to errors".
