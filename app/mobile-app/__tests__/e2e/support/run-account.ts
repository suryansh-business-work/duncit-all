 ...
 * One account lives its whole life across the specs in `specs/`, so its
 * password at each point is derived from the stage it has reached rather than
 * remembered between spec files.
 */
