...
/** Captures a required reason before re-opening a resolved ticket/chat (Bug 3/11). */
  ...
  return (
    <Backdrop testID="reopen-reason-modal">
      ...
      <Text fontSize={13} color="$muted">
        Tell us why you need to re-open it so the team can help faster.
      </Text>
      {deadlineLabel ? (
