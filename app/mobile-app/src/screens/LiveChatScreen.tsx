...
/** Live chat — a real-time support chat (text + images) with our team. Reached
 * from the Chat with Us inbox; mWeb twin of /live-chat. Agent pickup shows as a
 * system bubble. */
export function LiveChatScreen() {
  ...
  return (
    <StackScreen title="Chat live with an agent" testID="live-chat-screen">
      <YStack flex={1}>
        {chatBody}
