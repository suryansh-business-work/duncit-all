...
const STEPS = [
  { anchor: 'a', title: 'First thing', body: 'What it does.' },
  { anchor: 'b', title: 'Second thing', body: 'What that does.' },
];
...
describe('TourCard', () => {
  it('shows the step’s own copy and its place in the tour', () => {
    ...
    expect(screen.getByText('First thing')).toBeOnTheScreen();
    expect(screen.getByText('What it does.')).toBeOnTheScreen();
