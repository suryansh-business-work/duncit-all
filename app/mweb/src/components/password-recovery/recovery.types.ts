...
/**
 * The rules the three recovery steps validate against.
 *
 * All three are already in `@duncit/forms/schemas`: an email-or-phone value, a
 * six-digit code, and a password typed twice. Recovery asks the same three
 * questions the contact-change dialog and the change-password flow ask, so it
