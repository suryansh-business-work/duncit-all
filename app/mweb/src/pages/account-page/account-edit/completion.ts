/**
 * Profile-completion meter — a pure, read-only calculation shared by the
 * Account page card. Counts the meaningful profile fields the user can fill in
 * and returns the percentage that are present. RN twin lives in the mobile app's
 * `utils/profile-completion.ts`, so both surfaces show the same number.
 */
