...
export const interviewBookingFormSchema = yup.object({
  ...
  applicant_phone_extension: validationRules.phoneExtension('Phone code'),
  applicant_phone_number: validationRules.phoneNumber('Phone'),
...
export function toInterviewBookingInput(values: InterviewBookingFormValues) {
  ...
  return {
    ...
    applicant_phone: `${cast.applicant_phone_extension} ${cast.applicant_phone_number}`,
