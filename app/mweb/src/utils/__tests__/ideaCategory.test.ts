...
import { categoryPathLabel, ideaMatchesScope, type CategoryScope } from '../ideaCategory';

const scope = (over: Partial<CategoryScope> = {}): CategoryScope => ({
  super_category_id: '',
  category_id: '',
  sub_category_id: '',
  ...over,
...
const idea = { super_category_id: 's1', category_id: 'c1', sub_category_id: 'b1' };
