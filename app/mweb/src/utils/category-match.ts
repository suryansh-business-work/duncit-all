 ...
 * root-to-leaf path — equal, ancestor, or descendant — plus a direct
 * super-category match. This keeps a CATEGORY chip matching clubs tagged at its
 * SUB descendants (flat equality alone matched nothing and looked broken).
 *
