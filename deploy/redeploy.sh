...
SERVICES=(server admin mweb website partners-website partners-app ads crm track tech)
PORTS=(2001 2002 2003 2000 2004 2005 2006 2007 2008 2009)
...
for i in {1..30}; do
  if docker ps --format '{{.Names}} {{.Status}}' | grep -E 'duncit-(server|admin|mweb|website|partners-website|partners-app|ads|crm|track|tech)' | grep -vq 'Restarting\|Created'; then
    break
  fi
  sleep 2
done
