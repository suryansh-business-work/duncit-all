...
ALL_SERVICES=(server admin mweb website partners-website partners-app ads-portal ads-website native crm open-wa finance tech support website-app legal ai products marketing onboarding hr employee status earnwith challenge developers regional-club-admin venues clubs club-admins hosts pods)
declare -A PORT_OF=(
  ...
  [crm]=2007 [open-wa]=2024 [finance]=2008 [tech]=2009
  ...
  [earnwith]=2025 [challenge]=2026 [developers]=2027 [regional-club-admin]=2029
...
#
# WARNING: a service missing from ALL_SERVICES above is IGNORED, not an error —
# so a new portal deploys "successfully", nginx proxies to its port, and nothing
# is listening: a 502 with a green deploy. That is exactly what happened to
# venues/clubs/club-admins/hosts/pods. ADD EVERY NEW SERVICE TO BOTH
# ALL_SERVICES AND PORT_OF, in the same change that adds it to compose.
to_restart=()
