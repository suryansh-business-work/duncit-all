...
ALL_SERVICES=(server admin mweb website partners-website partners-app ads-portal ads-website native crm finance tech support website-app legal ai products marketing onboarding hr employee status)
declare -A PORT_OF=(
