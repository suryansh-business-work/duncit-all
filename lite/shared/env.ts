 ...
 * in production (nginx sends luma.* and luma-portal.* to this one service), so
...
export const SITE_URL = withoutTrailingSlash(pick(import.meta.env.VITE_LITE_SITE_URL, import.meta.env.PROD ? 'https://luma.duncit.com' : 'http://localhost:2041'));

export const PORTAL_URL = withoutTrailingSlash(pick(import.meta.env.VITE_LITE_PORTAL_URL, import.meta.env.PROD ? 'https://luma-portal.duncit.com' : 'http://portal.localhost:2041'));
