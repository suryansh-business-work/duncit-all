// The relocated console suites need what they needed inside the onboarding
// portal: jest-dom matchers, RTL cleanup, and the ResizeObserver / matchMedia /
// element-dimension stubs AG Grid cannot render without under jsdom.
