// Copied from the admin portal when the clubs console moved here: the console
// suites need the same providers every screen boots with (mocked Apollo, the
// shared confirm/notify hosts, a memory router, and the date/time localization
// the MUI X pickers refuse to render without). Test harness, not shipped code —
// the duplication gate ignores __tests__ for exactly this reason.
