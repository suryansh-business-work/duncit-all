...
/**
 * One club admin, in full — what a table row opens.
 *
 * Reuses ROW_FIELDS rather than listing the fields again: the detail page shows
 * everything the row carries plus nothing, so a field added to the list appears
 * here without a second edit.
 */
export const CLUB_ADMIN_DETAILS = gql`
  query ClubAdminDetails($id: ID!) {
