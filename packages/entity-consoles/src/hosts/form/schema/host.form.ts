...
import { AADHAR_PATTERN, PAN_PATTERN, PERSON_NAME_PATTERN } from '../../../shared/validation/rules';
import { blankBankAccountValues, normalizeBankAccountValues } from '../../../shared/validation/bankAccount';
import type { BankAccountValues } from '../../../shared/validation/bankAccount';
import { castHostBankAccount, hostBankAccountSchema } from './host-bank-account';
import { HOST_DOB_RANGE_ERROR, isValidHostDob } from '../hostDob';
