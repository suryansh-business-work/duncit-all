  ...
  const columns = useMemo<DuncitColumn<PodAuditLog>[]>(() => {
    ...
    return [
      ...
      },
      {
        ...
        type: 'enum',
        options: podAuditActionOptions(t),
        width: 150,
      ...
      },
      {
        ...
        type: 'enum',
        options: podAuditSourceOptions(t),
        width: 150,
      ...
      },
      {
        ...
        type: 'number',
        // The length of the entry's `changes` list — a count, not a stored field to order or match on.
        sortable: false,
        filterable: false,
        width: 100,
