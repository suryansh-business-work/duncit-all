...
export const FINANCE_BUNDLE: NestedCatalogue = {
  finance: {
    ...
    calculators: {
      addPod: 'Add pod',
      allPodsCombined: 'All pods combined',
      backToComparisons: 'Back to saved comparisons',
      calculatorName: 'Comparison name',
      clubAdminCut: 'Club admin cut',
      clubAdminCutDuncitIncome: 'Club admin cut — Duncit income',
      discardChanges: 'Discard changes',
      discardChangesBody: 'This comparison has edits that have not been saved. Leaving now throws them away.',
      discardChangesTitle: 'Leave without saving?',
      acrossAllPods: 'Across all pods',
      collection: 'Collection',
      collectionDetail: 'Ticket price x payable spots — the amount the waterfall runs on',
      gstDetail: 'Extracted from the collection, remitted to the government',
      hostAmountLessCommission: 'Host amount less commission',
      hostTakeHome: 'host take-home',
      hostShortfallDetail: 'The venue booked price exceeds the pool; the shortfall lands on the host',
      hostSpotFreeDetail: 'The host spot is free — the calculation is based on total spots minus 1',
      payouts: 'Payouts',
      remainingPoolDetail: 'Net minus platform fee — split between venue and host',
      taxesAndPool: 'Taxes & pool',
      totalDuncitRevenue: 'Total Duncit revenue',
      venueAmountLessCommission: 'Venue amount less commission',
      calculationDeleted: 'Calculation deleted',
      calculationName: 'Calculation name',
      calculationSaved: 'Calculation saved',
      deleteCalculationBody: 'This removes the saved calculation. The calculator on screen keeps its numbers.',
      deleteCalculationTitle: 'Delete this saved calculation?',
      downloadPdf: 'Download PDF',
      duncitRevenue: 'Duncit revenue',
      emailReport: 'Email report',
      everyFigureBelowTimesCount: 'Every figure below is the single pod above, multiplied by this count.',
      nameToSaveHint: 'Name it to save',
      newCalculation: 'New calculation',
      noCalculationsYet: 'No saved calculations yet — name one above and press Save.',
      reportEmailed: 'Report sent',
      reportUnavailable: 'The report could not be generated.',
      reset: 'Reset',
      saveBeforeExport: 'Save your changes first — the report is built from what is stored.',
      savedCalculationsIntro: 'Saved calculations are shared with the whole finance team. Click one to load it back into the calculator.',
      send: 'Send',
      sending: 'Sending…',
      sendTo: 'Send to',
      sendToHint: 'The PDF report is attached to the email.',
      singlePodIntro: 'Estimate the venue payout, host payout and Duncit revenue for a pod (ticket x spots) — mirrors the live finance engine.',
      totalNumberOfPods: 'Total number of pods',
      totalNumberOfPodsHint: 'How many identical pods to project. The breakdown stays per pod; the totals multiply by this.',
      comparisonDeleted: 'Comparison deleted',
      comparisonSaved: 'Comparison saved',
      deleteComparison: 'Delete comparison',
      deleteComparisonBody: 'This removes the comparison and every pod saved inside it. It cannot be undone.',
      ...
      multiPodIntro: 'Add a pod for every scenario you want to compare. Each one carries its own pricing and split, and the totals at the end add them all up.',
      noPodsAdded: 'No pods yet — add one to start comparing.',
      podName: 'Pod name',
      podNameHint: 'Name this pod so you can tell it apart in the list and in the totals below.',
      podsInComparison: 'Pods in this comparison',
      removeThisPod: 'Remove this pod',
      singlePod: 'Single pod',
      nameRequired: 'Give this comparison a name before saving.',
      newComparison: 'New comparison',
      noComparisonsYet: 'No saved comparisons yet — add one to get started.',
      podsColumn: 'Pods',
      savedComparisons: 'Saved comparisons',
      savedComparisonsIntro: 'Every comparison is saved for the whole finance team. Open one to edit its pods, or add a new one.',
      ...
      borneBy: 'Borne by',
      borneByDuncit: 'Duncit',
      borneByHost: 'Host',
      borneByVenue: 'Venue',
      chartGross: 'Gross',
      chartNet: 'Net',
      chartNetByParty: 'Gross vs net by party',
      chartNetByPartyHint: 'What each side is paid, and what is left once the costs they carry are taken off.',
      chartNoData: 'Enter a ticket price and spots to see the charts.',
      chartPodComparison: 'Pods compared',
      chartPodComparisonHint: 'Every pod in this comparison, scaled by its own count.',
      chartMoneySplit: 'Where the money goes',
      chartMoneySplitHint: 'The collection split four ways — it always adds back up to the total collection.',
      costsAndNet: 'Costs & net',
      duncitExpenses: 'Duncit expenses',
      duncitNet: 'Duncit net',
      expenseAmount: 'Amount',
      expenseLabel: 'Expense',
      expenseNamePlaceholder: 'Refreshments, travel, printing…',
      expenses: 'Expenses',
      expensesIntro: 'Costs for ONE pod. Each expense comes off the side that carries it, so the payouts above are untouched and the net below is what that side keeps.',
      hostExpenses: 'Host expenses',
      hostNet: 'Host net',
      noExpensesYet: 'No expenses yet — add one to see net profit after costs.',
      removeExpense: 'Remove expense',
      totalExpenses: 'Total expenses',
      venueExpenses: 'Venue expenses',
      venueNet: 'Venue net',
    },
    cancellations: {
      actor: 'Actor',
    ...
    expenseManagement: {
      ...
      title: 'Duncit Expenses',
      subtitle:
        'What Duncit spent, what it was spent on, and how much of it has come back. Click a row to open it.',
      newExpense: 'New expense',
      expenseDetails: 'Expense details',
      addExpense: 'Add expense',
      deleteExpenseConfirm: 'This expense and every refund recorded against it will be removed.',
      searchExpenses: 'Search vendor, entity, payer, description or reference',
      receiptHint: 'Image or PDF — the proof behind the spend.',
      pickASpendDate: 'Pick the day the money left',
      pickACategory: 'Pick a category',
      pickAPaymentMethod: 'Pick how it was paid',
      pickARelatedEntity: 'Pick what this expense was for',
      compensationOverAmount: 'Compensation cannot be more than the expense itself',
      tooLong: 'Too long',
    },

    // Finance > Settings > Expense Settings, and the configured dropdowns it
    // edits. The option LABELS are data and live in the database — only the
    // chrome around them is copy.
    expenseConfig: {
      title: 'Expense Settings',
      subtitle:
        'Every dropdown the Expense screens render. Add, reword, reorder or switch off an option here and it changes everywhere, with no release.',
      kindRelatedFrom: 'Expense Related From',
      kindCategory: 'Expense Categories',
      kindPaymentMethod: 'Payment Methods',
      kindCompensationMethod: 'Compensation Methods',
      option: 'Option',
      addOption: 'Add option',
      editOption: 'Edit option',
      deleteOption: 'Delete option',
      deleteOptionConfirm: '{label} will be removed from this list for good.',
      cannotDelete:
        'Built-in options and options already used by an expense cannot be deleted — switch them off instead.',
      disableRatherThanDelete:
        'Switching an option off removes it from the form and keeps it labelling every expense already filed under it.',
      noOptionsYet: 'This list has no options yet.',
      searchOptions: 'Search by name or key',
      displayName: 'Display name',
      displayNameHint: 'What a person reads on the form.',
      storedKey: 'Stored key',
      keyLocked: 'The key is what every expense filed under this option stores, so it never changes.',
      keyPreview: 'Saved as {key}',
      keyRequired: 'Give the option a key',
      labelRequired: 'Give the option a display name',
      entitySource: 'Entity list',
      entitySourceHint: 'Which list this type searches when somebody picks an entity.',
      noEntityList: 'No entity list',
      offeredOnTheForm: 'Offered on the Expense form',
      offered: 'Offered',
      hidden: 'Hidden',
      usedBy: 'Used by',
      origin: 'Origin',
      ...
      // The Related From pair, wherever it is rendered.
      relatedFrom: 'Expense Related From',
      relatedFromHint: 'What this money was spent on. Leave it empty for a general business cost.',
      relatedEntity: 'Related entity',
      notAttributed: 'Not attributed',
      noEntities: 'Nothing matches that search.',
      pickTypeFirst: 'Pick an Expense Related From type first.',
      anyOption: 'Any',
      retiredOption: '{key} (no longer offered)',

      // Compensation, on the form and in the table.
      ...
      compensationReference: 'Compensation reference / txn id',
      compensatedAmount: 'Compensated amount',
      compensated: 'Compensated',
      markRejected: 'Reject this expense — nobody pays it back',
      notDecidedYet: 'Not decided yet',
      statusIsDerived: 'The status follows the compensated amount, so there is nothing to keep in step.',
      statusPending: 'Pending compensation',
      statusPartial: 'Partially compensated',
      statusFull: 'Fully compensated',
      statusRejected: 'Rejected',

      paidBy: 'Paid by',
      paidByHint: 'Who actually paid it out.',
      receipt: 'Receipt',
      upload: 'Upload',
    },
    ...
    expenseDashboard: {
      ...
      subtitle:
        'Where the money went and how much of it has come back. Every filter drives the tiles and the breakdowns together.',
      totalExpenses: 'Total expenses',
      totalCompensation: 'Total compensation',
      stillOwed: 'Pending compensation',
      stillOwedHint: 'Not yet paid back, and not rejected',
      currentMonth: 'This month',
      previousMonth: 'Last month {amount}',
      expenseCount: '{count} expense(s)',
      pendingCompensation: 'Pending compensation',
      partiallyCompensated: 'Partially compensated',
      fullyCompensated: 'Fully compensated',
      rejectedExpenses: 'Rejected expenses',
      byCategory: 'Expense by category',
      byRelatedType: 'Expense by related entity type',
      byCompensationMethod: 'Expense by compensation method',
      nothingToBreakDown: 'No expenses match these filters.',
