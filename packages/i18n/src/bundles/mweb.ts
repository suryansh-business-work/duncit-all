...
export const MWEB_BUNDLE: NestedCatalogue = {
  mweb: {
    a11y: {
      ...
      leaderboardPeriod: 'Time period',
      surveyProgress: 'Interests picked',
      mainNavigation: 'Main navigation',
      unread: 'Unread',
      notificationsUnread: 'Notifications ({count} unread)',
      sponsoredTitle: 'Sponsored: {title}',
      ...
      goToStory: 'Go to story {number}',
      openStatusNumber: 'Open status {number}',
      seeLikes: '{count}, see who liked',
      openFiltersActive: 'Open filters ({count} active)',
      followTarget: '{action} {name}',
      messageSending: 'Sending',
      messageSent: 'Sent',
      messageSeen: 'Seen',
      notHelpful: 'Not helpful',
      starRating: '{rating} out of 5 stars',
      rateStars: 'Rate {stars} out of 5',
    ...
    meta: {
      ...
      search: { title: 'Search' },
      saved: { title: 'Saved' },
      contacts: { title: 'Your Contacts on Duncit' },
      clubs: { title: 'Clubs' },
      chats: { title: 'Chats' },
      register: {
    ...
    profile: {
      ...
      tabPosts: 'Posts',
      tabTheirPods: 'Their Pods',
      tabMyPods: 'My Pods',
      noJoinedPods: 'No pods joined yet.',
      noHostedPods: 'No pods hosted yet.',
      podsLoadFailed: 'Pods could not be loaded.',
    },
    profileAvatar: {
    ...
    contacts: {
      sidebarLabel: 'Your Contacts on Duncit',
      sidebarCaption: 'See who from your phone is here',
      title: 'Your Contacts on Duncit',
      subtitle: 'Find the people you already know, follow them and join their pods.',
      allowTitle: 'Allow contact access',
      allowBody:
        'Duncit reads the phone numbers in your contacts to find friends who already have an account. Only the matches are kept — never your phone book.',
      ...
      matched: {
        ...
        other: '{count} contacts are on Duncit',
      },
      noneMatched: 'None of your contacts are on Duncit yet. Invite them and check back.',
      notSyncedYet: 'Allow contact access to see who from your phone is already here.',
      pickerUnavailable:
      ...
      radarLabel: 'Radar of your contacts on Duncit',
      you: 'You',
      nearbyBadge: 'Nearby',
      ...
      clearConfirmBody:
        'Duncit will forget which of your contacts are here. You can allow access again any time.',
      cleared: 'Synced contacts removed.',
    },
    registerVenue: {
