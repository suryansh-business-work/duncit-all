...
export const POD_FORM_BUNDLE: NestedCatalogue = {
  podForm: {
    ...
    autoPod: {
      ...
      stepReview: 'Review & roll out',
      next: 'Next',
      back: 'Back',
      rollOut: 'Roll out Auto Pod',
      saveChanges: 'Save changes',
      saving: 'Saving…',
      fixErrors: 'Fix the highlighted fields before continuing.',
      // Step 1: who could enrol in the chosen category.
      audienceTitle: 'Who can enrol',
      audienceHint:
        'Counted for the category above. Every count must be above zero before the pod can be rolled out — click one to see who is behind it.',
      audienceVenues: 'Venues',
      audienceHosts: 'Hosts',
      audienceClubAdmins: 'Club admins',
      audienceRoleVenues: 'venues',
      audienceRoleHosts: 'hosts',
      audienceRoleClubAdmins: 'club admins',
      audienceLoading: 'Counting…',
      audienceError: 'Could not count the partners for this category.',
      audienceBlocked:
        'This category has no {roles} yet — the pod could never go live. Pick another category, or onboard partners first.',
      drawerVenues: 'Venues in this category',
      drawerHosts: 'Hosts in this category',
      drawerClubAdmins: 'Club admins in this category',
      drawerClose: 'Close',
      drawerSearch: 'Search…',
      drawerEmpty: 'Nobody yet.',
      colVenue: 'Venue',
      colCity: 'City',
      ...
      reviewOffers: 'What this pod offers',
      reviewPerks: 'Available perks',
      reviewProducts: 'Approved products',
      reviewProductLine: '{name} × {quantity}',
      reviewMedia: 'Images & videos',
      reviewMediaCount: '{n} file(s)',
      reviewReel: 'Pod reel',
      reviewNone: '—',
    },
    aboutSection: {
