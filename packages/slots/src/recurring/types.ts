// Pure types for the Recurring Availability engine. The generator is the
...
/**
 * Why a recurring run cannot be generated. Codes rather than sentences: the
 * engine is framework-free and shared with the native app, so the words live
 * in the `availability.*` bundle and `recurringErrorMessage` joins the two.
 */
