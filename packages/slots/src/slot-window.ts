...
/**
 * The two instants every slot carries. Structural on purpose: the venue row,
 * the generated recurring slot and the native app's own row all satisfy it
 * without this package importing any of their types.
 */
 ...
 */
export function slotCoversDay(slot: SlotSpan, day: Date): boolean {
...
export function slotCoveredDays(slot: SlotSpan): Date[] {
