...
/**
 * The searchable picker down the left of a master–detail console page — the
 * email Templates and Fragments pages and the Package Documentation list.
 *
 * One component rather than near-identical lists: the pages differ only in
 * what they call a row. Both had the same problem — thirty-five
