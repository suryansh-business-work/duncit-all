...
import type { AdRequestFormValues } from '../../src/pages/create-ad-page/ad-request';
import {
  adPricingMock,
...
// Component stubs: the real RHF form + estimate card have their own specs. The
// probe lets us drive onValuesChange/onSubmit directly with typed mock values.
...
vi.mock('../../src/pages/create-ad-page/EstimateCard', () => ({
  default: (props: { position: string; loading: boolean }) => (
