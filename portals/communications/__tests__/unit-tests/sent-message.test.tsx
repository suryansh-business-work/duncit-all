...
import SentMessage from '../../src/pages/whatsapp-page/wa-message';
import RecipientMessageDialog from '../../src/pages/whatsapp-page/wa-campaign-detail/RecipientMessageDialog';
import SentVariables from '../../src/pages/whatsapp-page/wa-message/SentVariables';
import { AISENSY_CATALOGUE } from '../../src/pages/whatsapp-page/queries';
