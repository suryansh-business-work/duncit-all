...
/** The windows the board can be read over, in days. */
export const RANGE_OPTIONS = [
  { value: 1, labelKey: 'tech.graphqlMonitor.range24Hours' },
  { value: 7, labelKey: 'tech.graphqlMonitor.range7Days' },
  { value: 30, labelKey: 'tech.graphqlMonitor.range30Days' },
] as const;
