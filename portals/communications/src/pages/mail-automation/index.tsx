...
const redirectUri = `${graphqlUrl.replace('/graphql', '')}/gmail/oauth/callback`;

/**
 * Communications > Mail Automation: step 1, and ONLY step 1.
 *
 * Connecting a mailbox hands Duncit a Google grant, which is a credential and
 * therefore this console's. What the mailbox then says, and which queue it opens, is a
