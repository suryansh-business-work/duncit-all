...
const ROUTES = [
  ...
  '/',
  '/venue-leads',
  '/venue-leads/services',
  '/venue-leads/new',
  '/venue-leads/smoke-id/view',
  '/venue-leads/smoke-id',
  '/host-leads',
  '/host-leads/services',
  '/host-leads/new',
  '/host-leads/smoke-id/view',
  '/host-leads/smoke-id',
  '/ecomm-leads',
  '/ecomm-leads/services',
  '/ecomm-leads/new',
  '/ecomm-leads/smoke-id/view',
  '/ecomm-leads/smoke-id',
  '/user-leads',
  '/user-leads/smoke-id',
  '/tools/whatsapp',
  '/call-prompts',
  '/email-templates',
  '/email-templates/smoke-id',
  '/reminders',
  '/data/services-offered',
  '/data/venues/amenities',
  '/data/venues/event-suitability',
