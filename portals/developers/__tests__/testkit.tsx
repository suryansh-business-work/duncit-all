...
/**
 * Renders a component inside the providers every developers-portal screen relies
 * on: Apollo (mocked), the color-mode/theme provider, the MUI X date
 * localization provider, and an in-memory router.
 *
