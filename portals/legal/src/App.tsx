...
import BrandConsentPage from './pages/brand-consent/BrandConsentPage';
...
export default function App() {
  return (
    <Routes>
      ...
      <Route path="/brand-consent" element={authed(<BrandConsentPage />)} />
      ...
      <Route path="/reports" element={authed(<UserReportsPage />)} />
