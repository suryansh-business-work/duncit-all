...
export default function LocaleFlagSwitches({
  ...
  const lockHint = t('localization.locales.defaultLockedSwitch');
  ...
  return (
    <Stack spacing={0.5}>
      <FormControlLabel
        ...
        label={lockedAsDefault ? lockHint : t('localization.locales.activeHint')}
      />
      <FormControlLabel
        control={<Switch checked={isRtl} onChange={(_, value) => onChange('is_rtl', value)} />}
        label={t('localization.locales.rtl')}
      />
      <FormControlLabel
        control={
          <Switch
        ...
        label={lockedAsDefault ? lockHint : t('localization.locales.defaultHint')}
      />
    </Stack>
  );
}
