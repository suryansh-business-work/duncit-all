...
import { TRANSLATIONS_TABLE, type LocaleRow, type TranslationRow } from '../../lib/queries';
...
export default function TranslationEntriesTable({
  ...
  return (
    <DuncitTable<TranslationRow>
      tableId="localization-translations"
      columns={columns}
      fetchRows={fetchRows}
      getRowId={getRowId}
      onRowClick={onOpen}
      emptyText={t('localization.translations.entriesEmpty')}
      defaultSort={{ field: 'key', dir: 'asc' }}
      searchPlaceholder={t('localization.translations.searchEntries')}
