...
import { TRANSLATION_GROUPS, type LocaleRow, type TranslationGroupRow } from '../../lib/queries';
...
export default function TranslationGroupsTable({
  ...
  return (
    <DuncitTable<TranslationGroupRow>
      tableId="localization-translation-groups"
      columns={columns}
      fetchRows={fetchRows}
      getRowId={getRowId}
      onRowClick={onOpen}
      emptyText={t('localization.translations.namespacesEmpty')}
      defaultSort={{ field: 'surface', dir: 'asc' }}
      searchPlaceholder={t('localization.translations.searchNamespaces')}
