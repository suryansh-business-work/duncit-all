...
describe('hasAppAccess', () => {
  it('grants access to the configured MARKETING_MANAGER role', () => {
    expect(hasAppAccess(['MARKETING_MANAGER'])).toBe(true);
  });
  ...
  it('uses MARKETING_MANAGER as the default required role', () => {
