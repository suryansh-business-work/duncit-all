...
export default function CampaignTable({
  ...
  const columns = useMemo<DuncitColumn<MarketingCampaignRow>[]>(
    () => [
      ...
      { field: 'recipient_count', headerName: t('marketing.common.recipients'), type: 'number', width: 120 },
      { field: 'open_count', headerName: t('marketing.marketingCampaigns.opened'), type: 'number', width: 110 },
      { field: 'click_count', headerName: t('marketing.common.clicked'), type: 'number', width: 110 },
      {
        field: 'audience',
  ...
  return (
    <DuncitTable<MarketingCampaignRow>
      ariaLabel={t('shell.nav.campaigns')}
