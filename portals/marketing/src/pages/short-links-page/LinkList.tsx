 ...
 * links that leave Duncit. Written once, because a second copy is where the
 * two would start disagreeing about what deleting a link costs (rule 40).
 */
const VARIANTS: Record<LinkListVariant, VariantConfig> = {
  ALL: {
