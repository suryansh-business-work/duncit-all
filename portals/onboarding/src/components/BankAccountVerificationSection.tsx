...
export default function BankAccountVerificationSection({ value, onChange, errorFor }: Readonly<Props>) {
  ...
  return (
    <Box sx={{ display: 'grid', gap: 1.5, gridTemplateColumns: { xs: '1fr', sm: '1fr 1fr' } }}>
      <TextField
        select
        label={t('onboarding.bankAccountVerificationSection.payoutMethod')}
        size="small"
      ...
      <TextField
        label={t('onboarding.bankAccountVerificationSection.accountHolderName')}
        size="small"
      ...
      {isUpi && (
        <TextField
          label={t('onboarding.bankAccountVerificationSection.upiId')}
          size="small"
          value={value.upi_id}
      ...
      {showBankRails && (
        <>
          <TextField
            label={t('onboarding.bankAccountVerificationSection.accountNumber')}
            size="small"
          ...
          />
          <TextField
            label={t('onboarding.bankAccountVerificationSection.ifscCode')}
            size="small"
