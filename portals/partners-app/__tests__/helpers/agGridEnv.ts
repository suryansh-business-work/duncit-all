/**
 * jsdom shims AG Grid needs (used by @duncit/table). Import this module at the
 * top of any test file that renders a DuncitTable-backed component; vitest
 * isolates environments per file, so the prototype patches stay file-local.
 */
