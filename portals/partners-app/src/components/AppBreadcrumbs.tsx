...
const PARTNER_NAV: { label: string; to: string; match: string }[] = [
  ...
  { label: 'Club Admin', to: '/club-admin', match: '/club-admin' },
  { label: 'Dashboard', to: '/club-admin/dashboard', match: '/club-admin/dashboard' },
  { label: 'Clubs', to: '/club-admin/clubs', match: '/club-admin/clubs' },
