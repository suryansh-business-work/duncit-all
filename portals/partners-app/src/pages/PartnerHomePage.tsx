      ...
      <Box sx={{ display: 'grid', gap: 2, gridTemplateColumns: { xs: '1fr', sm: 'repeat(3, 1fr)' } }}>
        {actions.map((action) => (
          <Card key={action.path} variant="outlined" sx={{ borderRadius: 2 }}>
            <CardContent>
              <Stack spacing={1.5}>
                <Box sx={{ height: 132, borderRadius: 1.25, display: 'grid', placeItems: 'center', bgcolor: alpha(theme.palette.primary.main, 0.08), border: 1, borderColor: 'divider', color: 'primary.main' }}>
