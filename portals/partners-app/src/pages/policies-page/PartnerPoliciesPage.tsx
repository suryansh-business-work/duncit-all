  ...
  return (
    <Stack spacing={2.25}>
      <Box sx={{ p: 2.25, borderRadius: 2, color: '#fff', background: 'linear-gradient(145deg, #15111c 0%, #2a1926 55%, #111827 100%)' }}>
        ...
        <Typography variant="h4" fontWeight={950}>{t('shell.nav.policies')}</Typography>
        ...
        <Card variant="outlined" sx={{ borderRadius: 2, width: { xs: '100%', md: 260 }, flexShrink: 0 }}>
          <CardContent>
            <Stack spacing={1}>
              ...
              {policies.length === 0 && !loading && <Typography variant="body2" color="text.secondary">{t('partners.policiesPage.noActivePoliciesYet')}</Typography>}
