...
const columns = (t: Translate): DuncitColumn<VenueListingRow>[] =>[
  ...
  { field: 'venue_type', headerName: t('shell.common.type'), hide: true, type: 'text', minWidth: 130 },
  { field: 'city', headerName: t('partners.common.city'), hide: true, type: 'text', minWidth: 130 },
  { field: 'locality', headerName: t('partners.common.locality'), hide: true, type: 'text', minWidth: 140 },
  {
    field: 'created_at',
  ...
  { field: 'actions', headerName: t('partners.common.action'), type: 'actions', width: 230, cellRenderer: renderActions },
];
