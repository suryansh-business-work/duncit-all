...
import FeatureFlagsTable from '../../src/pages/feature-flags-page/FeatureFlagsTable';
import type { FeatureFlagRow } from '../../src/pages/feature-flags-page/queries';
import { makeFeatureFlagRow } from '../mocks/feature-flag.mock';
...
describe('FeatureFlagsTable', () => {
  ...
  it('renders system/custom rows, the em-dash for missing descriptions, and wires actions', async () => {
    const onToggle = vi.fn(),
      ...
      onRemove = vi.fn();
    const flags = [
      makeFeatureFlagRow({ id: '1', key: 'sys_flag', name: 'System Flag', description: 'has desc', enabled: true, is_system: true }),
      makeFeatureFlagRow({ id: '2', key: 'cust_flag', name: 'Custom Flag', description: '', enabled: false, is_system: false }),
    ];
    render(
      <FeatureFlagsTable
