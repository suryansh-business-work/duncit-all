...
import * as envQueries from '../../src/pages/environment/queries';
import * as portalEnvQueries from '../../src/pages/environment/portal-env-queries';
import * as envEntryBarrel from '../../src/pages/environment/env-entry';
 ...
 * assertions pin the public surface so the imports aren't tree-shaken (the
 * gql-only query modules are excluded from coverage; the form barrels + theme
