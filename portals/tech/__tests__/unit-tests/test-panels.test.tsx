...
import type { EnvEntry } from '../../src/pages/environment/queries';
import { makeEnvEntry } from '../mocks/env-entry.mock';
...
import TestDrawer from '../../src/pages/environment/test-panels/index';
import ResultAlert from '../../src/pages/environment/test-panels/ResultAlert';
import EmailTestPanel from '../../src/pages/environment/test-panels/EmailTestPanel';
import ImagekitTestPanel from '../../src/pages/environment/test-panels/ImagekitTestPanel';
import PexelsTestPanel from '../../src/pages/environment/test-panels/PexelsTestPanel';
import CallTestPanel from '../../src/pages/environment/test-panels/CallTestPanel';
import AiTestPanel from '../../src/pages/environment/test-panels/AiTestPanel';
import GoogleMapsTest from '../../src/pages/environment/test-panels/GoogleMapsTest';
import GoogleOAuthTab from '../../src/pages/environment/test-panels/GoogleOAuthTab';
import GoogleOAuthTest from '../../src/pages/environment/test-panels/GoogleOAuthTest';

const entry = (over: Partial<EnvEntry> = {}): EnvEntry => makeEnvEntry({ id: 'e1', name: 'Primary', ...over });
