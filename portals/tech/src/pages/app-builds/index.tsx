...
import { APP_BUILDS_TABLE, type AppBuildPlatform, type AppBuildRow } from './queries';
 ...
 * ios-build workflows report every merge-to-main build here (artifact on
 * ImageKit, announcement on Slack); this table is the store of record.
 */
