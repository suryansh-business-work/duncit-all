...
export default function BugsTable({
  ...
  const columns = useMemo<DuncitColumn<BugRow>[]>(() => {
    ...
    return [
      ...
      { field: 'title', headerName: t('tech.bugs.bug'), flex: 1.6, minWidth: 240, type: 'text', cellRenderer: renderTitle },
      { field: 'source', headerName: t('tech.common.source'), width: 140, type: 'text' },
      { field: 'page', headerName: t('tech.common.page'), flex: 1, minWidth: 150, type: 'text' },
      { field: 'occurrence_count', headerName: t('tech.bugs.count'), width: 90, type: 'number' },
      {
      ...
      {
        // Sorts and filters on the account's name (last_user.name on the server).
        field: 'last_user',
      ...
      },
      {
        ...
        width: 120,
        type: 'text',
        // Assembled in JS from three env_counts fields — no one stored value to
        // order or match on.
        sortable: false,
        filterable: false,
      ...
      { field: 'last_seen_at', headerName: t('tech.bugs.lastSeen'), width: 180, type: 'date', cellRenderer: renderLastSeen },
      {
        field: 'actions',
        headerName: '',
        width: 140,
