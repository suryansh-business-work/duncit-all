...
export default function FeatureFlagsTable({
  ...
  const columns = useMemo<DuncitColumn<FeatureFlagRow>[]>(() => {
    ...
    return [
      ...
      { field: 'key', headerName: t('tech.featureFlags.key'), flex: 1, minWidth: 160, type: 'text', cellRenderer: renderKey },
      { field: 'name', headerName: t('shell.common.name'), flex: 1, minWidth: 160, type: 'text' },
      {
        field: 'description',
