...
describe('hasAppAccess', () => {
  it('grants access to the configured WEBSITE_MANAGER role', () => {
    expect(hasAppAccess(['WEBSITE_MANAGER'])).toBe(true);
  });
  ...
  it('uses WEBSITE_MANAGER as the default required role', () => {
