...
export default function NavigationTable({
  ...
  const columns = useMemo<DuncitColumn<WebsiteNavItem>[]>(() => {
    ...
    return [
      ...
      { field: 'label', headerName: t('websiteApp.navigation.colLabel'), type: 'text', flex: 1, minWidth: 150 },
      { field: 'url', headerName: t('websiteApp.navigation.url'), type: 'text', flex: 1, minWidth: 200 },
