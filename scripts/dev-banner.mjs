...
const projects = [
  ...
  { label: 'regional-club-admin',      port: 2029 },
  { label: 'venues',                   port: 2030 },
  { label: 'clubs',                    port: 2031 },
  { label: 'club-admins',              port: 2032 },
  { label: 'pods',                     port: 2034 },
  { label: 'hosts',                    port: 2033 },
  { label: 'communications',           port: 2035 },
  { label: 'logs',                     port: 2036 },
