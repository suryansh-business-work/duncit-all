...
export const OPENAI_TASKS = {
  ...
  'moderation.social_comment': { label: 'Social comment review', module: 'Moderation' },
  ...
  'marketing.social_post_analysis': { label: 'Social post analysis', module: 'Marketing' },
  'marketing.social_insights': { label: 'Social performance insights', module: 'Marketing' },
  'marketing.social_ideas': { label: 'Social post ideas', module: 'Marketing' },
