...
import { inventoryTypeDefs } from './inventory/inventory.schema';
import { inventoryResolvers } from './inventory/inventory.resolver';
import { partnerDashboardTypeDefs } from './partnerDashboard/partnerDashboard.schema';
import { partnerDashboardResolvers } from './partnerDashboard/partnerDashboard.resolver';
import { websiteContentTypeDefs } from './websiteContent/websiteContent.schema';
import { websiteContentResolvers } from './websiteContent/websiteContent.resolver';
import { marketingTypeDefs } from './marketing/marketing.schema';
import { marketingResolvers } from './marketing/marketing.resolver';
import { crmTypeDefs } from './crm/crm.schema';
import { crmResolvers } from './crm/crm.resolver';
import { commsProviderTypeDefs } from './commsProvider/commsProvider.schema';
import { commsProviderResolvers } from './commsProvider/commsProvider.resolver';
import { communicationLogTypeDefs } from './communicationLog/communicationLog.schema';
import { communicationLogResolvers } from './communicationLog/communicationLog.resolver';
import { bouncerTypeDefs } from './bouncer/bouncer.schema';
import { bouncerResolvers } from './bouncer/bouncer.resolver';
import { venueSlotTypeDefs } from './venueSlot/venueSlot.schema';
