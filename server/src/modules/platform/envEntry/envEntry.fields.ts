...
export const CATEGORY_FIELDS: Record<EnvCategory, EnvFieldDef[]> = {
  ...
  LIVEKIT: [
    { name: 'url', label: 'Server URL', hint: 'wss://<project>.livekit.cloud, or your own server' },
    { name: 'api_key', label: 'API Key', hint: 'API key from the LiveKit project' },
    { name: 'api_secret', label: 'API Secret', secret: true, hint: 'Signs the join tokens — never leaves the server' },
  ],
  TWILIO: [
...
export const CATEGORY_DOCS: Record<EnvCategory, string> = {
  ...
  LIVEKIT: 'https://docs.livekit.io/home/cloud/keys-and-tokens/',
...
export const ENV_KEY_MAP: Record<string, { category: EnvCategory; field: string }> = {
  ...
  LIVEKIT_URL: { category: 'LIVEKIT', field: 'url' },
  LIVEKIT_API_KEY: { category: 'LIVEKIT', field: 'api_key' },
  LIVEKIT_API_SECRET: { category: 'LIVEKIT', field: 'api_secret' },
