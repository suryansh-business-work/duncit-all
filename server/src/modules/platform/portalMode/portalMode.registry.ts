...
export const PORTAL_REGISTRY: PortalRegistryEntry[] = [
  ...
  { key: 'regional-club-admin', name: 'Regional Club Admin', kind: 'PORTAL', url: 'https://regional-club-admin.duncit.com/' },
  { key: 'venues', name: 'Venues', kind: 'PORTAL', url: 'https://venues.duncit.com/' },
  ...
  { key: 'localization', name: 'Localization', kind: 'PORTAL', url: 'https://localization.duncit.com/' },
