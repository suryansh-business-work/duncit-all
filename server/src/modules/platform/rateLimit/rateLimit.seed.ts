...
const SEED_SYSTEMS: SeedSystem[] = [
  ...
  { surface: 'PORTAL', app: 'analytics', label: 'Analytics Portal' },
  { surface: 'PORTAL', app: 'challenge', label: 'Challenges Portal' },
  { surface: 'PORTAL', app: 'communications', label: 'Communications Portal' },
  { surface: 'PORTAL', app: 'crm', label: 'CRM Portal' },
  { surface: 'PORTAL', app: 'ecomm-portal', label: 'E-commerce Portal' },
  { surface: 'PORTAL', app: 'developers', label: 'Developers Portal' },
  { surface: 'PORTAL', app: 'employee', label: 'Employee Portal' },
  { surface: 'PORTAL', app: 'club-admins', label: 'Club Admins Portal' },
  { surface: 'PORTAL', app: 'clubs', label: 'Clubs Portal' },
  { surface: 'PORTAL', app: 'hosts', label: 'Hosts Portal' },
  { surface: 'PORTAL', app: 'pods', label: 'Pods Portal' },
  { surface: 'PORTAL', app: 'regional-club-admin', label: 'Regional Club Admin Portal' },
  { surface: 'PORTAL', app: 'venues', label: 'Venues Portal' },
  ...
  { surface: 'WEBSITE', app: 'ecomm', label: 'Pet Store (ecomm.duncit.com)' },
...
const SEED_RULES = [
  ...
  {
    name: 'Pet store checkout and order lookup',
    description:
      'The pet store answers anonymous callers: a Cash-on-Delivery code texts a phone, placing an order books stock, and a guest order lookup takes an order number and a contact. Enforcing from day one — a real shopper does each of these a handful of times.',
    priority: 6,
    mode: 'ENFORCE',
    surface: 'ALL',
    app: '*',
    channel: 'GRAPHQL',
    operations: ['storeRequestCodOtp', 'storeVerifyCodOtp', 'storePlaceOrder', 'storeTrackOrder'],
    key_by: 'IP',
    algorithm: 'SLIDING_WINDOW',
    limit: 20,
    window_seconds: 300,
