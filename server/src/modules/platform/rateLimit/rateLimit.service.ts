...
const RULE_TABLE = {
  ...
  filterFields: {
    ...
    hit_count: { type: 'number' as const },
    blocked_count: { type: 'number' as const },
    last_blocked_at: { type: 'date' as const },
...
const EVENT_TABLE = {
  ...
  filterFields: {
    rule_name: { type: 'string' as const },
    limit_key: { type: 'string' as const },
    operation: { type: 'string' as const },
    count: { type: 'number' as const },
    retry_after: { type: 'number' as const },
    mode: { type: 'enum' as const },
    surface: { type: 'enum' as const },
    app: { type: 'string' as const },
    channel: { type: 'enum' as const },
