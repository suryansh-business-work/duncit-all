...
export const ECOMM_EMAILS: readonly EmailDef[] = [
  defineEmail({
    slug: 'ecomm-brand-submitted',
    name: 'Brand: Submitted for Review',
    description: 'The brand owner, the moment they submit a brand from the wizard — what happens next and where to watch it.',
    audience: 'ECOMM',
    category: 'notification',
    fires: 'A brand is submitted for review',
    waEvent: 'ECOMM_BRAND_SUBMITTED',
    subject: '{{brand}} is under review',
    footerNote: FOOTER.brand,
    vars: [
      v('name', 'The owner’s first name.', 'Ananya'),
      v('brand', 'The brand’s name.', 'Yonex'),
      v('brand_url', 'The brand in the Partners console.', 'https://partners-app.duncit.com/ecomm-brand'),
    ],
    body: {
      copyKey: 'email.ecommBrandSubmitted',
      nameVar: 'name',
      tone: PAUSED,
  ...
  defineEmail({
    slug: 'ecomm-brand-rejected',
    name: 'Brand: Not Approved',
    description: 'The brand owner, when the Products team rejects a submitted brand — with the reviewer’s reason, so they can fix it and resubmit.',
    audience: 'ECOMM',
    category: 'notification',
    fires: 'A submitted brand is rejected',
    waEvent: 'ECOMM_BRAND_REJECTED',
    subject: 'About your brand {{brand}}',
    footerNote: FOOTER.brand,
    vars: [
      v('name', 'The owner’s first name.', 'Ananya'),
      v('brand', 'The brand’s name.', 'Yonex'),
      v('reason', 'The reviewer’s notes, verbatim.', 'The GST certificate does not match the registered business name.'),
      v('brand_url', 'The brand in the Partners console.', 'https://partners-app.duncit.com/ecomm-brand'),
    ],
    body: {
      copyKey: 'email.ecommBrandRejected',
      nameVar: 'name',
      tone: STOPPED,
      calloutLabelKey: LABEL.brand,
      calloutVar: 'brand',
  ...
  defineEmail({
    slug: 'ecomm-brand-deleted',
    name: 'Brand: Removed',
    description: 'The brand owner, when a brand is deleted — by them from the wizard, or by the Products team with a reason.',
    audience: 'ECOMM',
    category: 'notification',
    fires: 'A brand is deleted',
    waEvent: 'ECOMM_BRAND_DELETED',
    subject: '{{brand}} has been removed',
    footerNote: FOOTER.brand,
    vars: [
      v('name', 'The owner’s first name.', 'Ananya'),
      v('brand', 'The brand’s name.', 'Yonex'),
      v('reason', 'Why, when the Products team removed it; blank when the owner did.', 'Duplicate of an existing brand.'),
    ],
    body: {
      copyKey: 'email.ecommBrandDeleted',
      nameVar: 'name',
      tone: STOPPED,
      calloutLabelKey: LABEL.brand,
      calloutVar: 'brand',
  ...
  defineEmail({
    slug: 'ecomm-brand-review-requested',
    name: 'Products team: Brand Awaiting Review',
    description: 'Every Products Manager, when a partner submits a brand — the inbox link, so nothing waits unnoticed.',
    audience: 'ADMIN',
    category: 'notification',
    fires: 'A brand is submitted for review',
    subject: 'Brand awaiting review: {{brand}}',
    footerNote: FOOTER.brand,
    vars: [
      v('name', 'The manager’s first name.', 'Priya'),
      v('brand', 'The brand’s name.', 'Yonex'),
      v('owner', 'Who submitted it.', 'Ananya Rao'),
      v('category', 'What the brand is listed under.', 'Sports Equipment'),
      v('review_url', 'The brand in the Products console.', 'https://products.duncit.com/ecomm/brands'),
    ],
    body: {
      copyKey: 'email.ecommBrandReviewRequested',
      nameVar: 'name',
      tone: CALM,
      calloutLabelKey: LABEL.brand,
      calloutVar: 'brand',
      rows: [
        { labelKey: FIELD.recipient, valueVar: 'owner' },
        { labelKey: FIELD.category, valueVar: 'category' },
      ],
      ctaKey: CTA.reviewRequest,
      ctaVar: 'review_url',
    },
