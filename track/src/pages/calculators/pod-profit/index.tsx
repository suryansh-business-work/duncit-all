...
import HostInputsCard from './HostInputsCard';
    ...
    <Stack spacing={2}>
      <Stack direction="row" alignItems="center" spacing={1.5}>
        ...
        <Box sx={{ flex: 1, minWidth: 0 }}>
          ...
          <Typography variant="body2" color="text.secondary">
            Estimate Duncit revenue + profit and the host payout for a single pod, with optional product add-ons.
          </Typography>
        </Box>
        <Button
          variant="outlined"
      ...
      <Stack direction={{ xs: 'column', lg: 'row' }} spacing={2} alignItems="flex-start">
        <Stack spacing={2} sx={{ flex: 1, minWidth: 0, width: '100%' }}>
          ...
          <HostInputsCard inputs={inputs} onChange={set} />
          <ProductsCard products={inputs.products} onChange={(products) => set('products', products)} />
        </Stack>
