...
/** Text made safe for an XML or HTML attribute or text node. */
export const escapeXml = (value: string): string => value.replaceAll(/[&<>"']/g, (char) => XML_ESCAPES[char] ?? char);
...
/** /sitemap.xml — every shelf, brand, page and product the API lists, as absolute URLs. */
